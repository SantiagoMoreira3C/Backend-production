...
const primaryColor = '#2A2399'; // Azul Clínico Oscuro (Títulos principales)
const accentColor = '#5249D6'; // Azul de Énfasis (Subtítulos, resaltados)
const highlightColor = '#5249D6'; // Nuevo color azul más suave para las respuestas y detalles
...
// 1. Título de la pregunta
    doc.font('Helvetica-Bold')
        .fontSize(13)
        .fillColor('black')
        .text(`• ${title}: `, { indent: 50, continued: true }); // DEJA continued: true aquí para que siga la respuesta

    // 2. Respuesta
    doc.font('Helvetica-Bold')
        .fillColor(highlightColor)
        // ELIMINA continued: true para que esta línea finalice el bloque
        .text(answerText); // <-- ¡Cambio clave! Ahora termina la línea
